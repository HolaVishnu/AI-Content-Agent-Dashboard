...
// NOTE: apify/instagram-post-scraper used to run here. Removed â€” it is a PAID
...
// reliably available through this actor either, so it's simply not pulled â€”
...
async function main() {
  ...
  } catch (e) { /* no existing file yet â€” fine */ }
  ...
  console.log('\nâœ“ Saved to dashboard/data.json');
  console.log('\nSummary:');
  console.log('  Profile stats:', Object.keys(profiles).length, 'accounts âœ“');
